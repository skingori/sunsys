...
if (isset($_GET['rep'])) {
    ...
    $result = mysqli_query($con, "SELECT * FROM booking WHERE id='$id' AND book_contact='$mobnum' AND cdate >= NOW() - INTERVAL 5 MINUTE"); // using mysqli_query instead
...
<table style="font-size: small" border=0 cellpadding="1" cellspacing="1" id="table1" width="100%" class="table table-hover table-condensed table-bordered table-striped">
    ...
    while($res = mysqli_fetch_array($result)) {
        ...
        echo "<td>".$res['bal_paid']."</td>";
        echo "<td>".$res['pmodebal']."</td>";
        echo "<td>".$res['mpesarefbal']."</td>";
        echo "<td>".$res['bankrefbal']."</td>";
