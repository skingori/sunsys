...
<div class="register-box-body">
        ...
        <div class="form-group has-feedback">
          ...
          <div class="form-group has-feedback">
            <label>End date:</label><input type="text" placeholder="End date" name="bookto" id="datepicker2" value="" class="form-control">
        ...
        <div class="form-group has-feedback">
            <label> Unit: </label>
            <input type=""  placeholder="Unit" name="ya" id="" value="" class="form-control" required/>
        </div>

        <div class="form-group has-feedback">
            <label>Deposit Paid:</label><input type=""  placeholder="Deposit paid" name="depositpaid" id="dep" value="" class="form-control" required/>
        </div>
...
")or die(mysql_error());
    ...
    $log_query=mysql_query("INSERT INTO logs(`activity`,`activity_by` ,`date`)
                        VALUES('Apartment booked ','By user' , now() )
                        ")or die(mysql_error());
    //end of logs
