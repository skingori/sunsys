          ...
          <div class="content_section">
            <div class="box">
              <div class="box-header">
                <h6 style="color: grey"> PAID APPLICATIONS.<br> P.O BOX 652567 NAIROBI.<br>
                  KENYA.<br>
              ...
              $query="SELECT * FROM booking WHERE apart_booked='$apartment' AND book_status='paid'";

              $resource=mysql_query($query,$conn);
              echo "
                                <table align=\"center\" border=\"\" width=\"100%\" class=\"table table-bordered table-striped\">
                                <tr>
                                <td><b>Apartment Name</b></td> <td><b>Booked By</b></td><td><b>Date Booked</b></td><td><b>Deposit Paid (Ksh)</b></td><td><b>Amount Paid(Ksh)</b></td></tr> ";
              while($result=mysql_fetch_array($resource))
              {
                echo "<tr><td>".$result[0]."</td><td>".$result[1]."</td><td>".$result[3]."</td><td>".$result[5]."</td><td>".$result[6]."</td></tr>";

                //get to tal amount
                $oamount=mysql_query("select SUM(deposit_paid + bal_paid) AS tamount FROM booking WHERE apart_booked='$apartment' AND book_status='paid'");
